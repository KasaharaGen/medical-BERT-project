...
# === CSV読み込み ===
df = pd.read_csv("data/infection_data/infection_merged.csv")
...
df_split.to_csv("data/infection_data/infection_sentences.csv", index=False)
print("✅ 正規化済み文データ saved to infection_sentences.csv")
